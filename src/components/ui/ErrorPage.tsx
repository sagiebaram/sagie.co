      ...
      <div className="relative z-10 flex flex-col items-center text-center px-6 max-w-lg mx-auto">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4">
          {onRetry && (
            <button
              onClick={onRetry}
              className="inline-block font-body uppercase transition-all duration-150 hover:-translate-y-px bg-button-primary-bg text-button-primary-text hover:opacity-85 text-button tracking-button px-[34px] py-4"
            >
              Try again
            </button>
          )}
