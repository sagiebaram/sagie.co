...
export function Navbar() {
  return (
    <nav
      className="fixed top-0 left-0 right-0 z-50 bg-background-nav backdrop-blur-[12px] border-b border-border-subtle"
    >
      <div className="max-w-[880px] mx-auto px-8 flex items-center justify-between h-16">
        ...
        <div className="flex items-center gap-4">
          ...
          <a
            href="#"
            className="font-body uppercase text-black bg-white hover:bg-gray-200 transition-colors duration-150 text-label tracking-button px-[22px] py-2.5"
          >
            Apply
          </a>
        </div>
