...
export function Hero() {
  return (
    <section className="relative z-[1] overflow-hidden min-h-screen bg-background">
      <GridBackground />
      <HeroAnimation>
        <div className="relative z-10 max-w-[880px] mx-auto px-8 min-h-screen grid grid-cols-1 md:grid-cols-2 gap-12 items-center pt-16">
          ...
          <div className="flex flex-col justify-center py-16">
            ...
            <div className="flex flex-wrap items-center gap-5">
              ...
              <Button variant="ghost" className="hero-cta">{HERO.secondaryCta}</Button>
            </div>
          </div>

          <div className="hidden md:flex items-center justify-center">
            <div className="relative w-full max-w-[420px]" style={{ aspectRatio: '1 / 0.6' }}>
              <Logo width={420} height={252} className="object-contain opacity-15" />
            </div>
          </div>
