...
export function ContributeGrid() {
  ...
  return (
    <Section id="ways">
      ...
      <p className="font-body text-foreground-muted text-body font-light leading-body max-w-[560px] mb-12">
        {desc}
      </p>
...
function ContributeCardTile({ card }: { card: ContributeCard }) {
  ...
  return (
    ...
    >
      ...
      <h3
        className="font-display uppercase text-foreground-secondary text-[26px] leading-display tracking-heading mb-3"
      >
        {card.title}
      </h3>

      <p className="font-body text-foreground-muted text-label font-light leading-body mb-7">
        {card.body}
      </p>
