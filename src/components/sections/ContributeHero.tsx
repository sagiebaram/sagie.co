    ...
    <section id="contribute-hero" className="relative z-1 overflow-hidden">
      ...
      <PageHeroAnimation>
        <div className="relative z-10 max-w-[880px] mx-auto px-6 md:px-8 pt-32 pb-16 md:pt-40 md:pb-24">
          ...
          <SplitTextReveal
            as="h1"
            className="font-display uppercase text-hero leading-display mb-8"
            lines={[
              { text: 'BUILD', className: 'text-foreground-muted' },
              { text: 'WITH', className: 'text-foreground-secondary' },
              { text: 'US.', className: 'text-foreground' },
            ]}
          />
          <p className="page-hero-sub font-body italic text-foreground-muted text-body font-light leading-body max-w-[480px] mb-10">
            {subtitle}
          </p>
