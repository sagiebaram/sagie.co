...
export function ContributeV2Why() {
  ...
  return (
    <Section id="v2-why">
      ...
      <h2 className="font-display uppercase text-foreground-secondary text-chapter leading-none tracking-heading mb-10">
        {title}
      </h2>
      ...
      <div className="max-w-[680px]">
        {paragraphs.map((p, i) => (
          <p
            ...
            className={
              i === 0
                ? 'font-display uppercase text-foreground tracking-heading text-heading leading-body mb-10 pl-6 border-l-2 border-[#C9A84C]'
                : 'font-body text-foreground-muted text-body font-light leading-body mb-6 last:mb-0'
            }
          >
            {p}
          </p>
