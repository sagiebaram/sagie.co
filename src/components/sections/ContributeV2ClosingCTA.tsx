  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-[1100px] mx-auto px-6 md:px-8 py-24 md:py-36 text-center">
        ...
        <h2 className="font-display uppercase text-foreground text-hero leading-display tracking-heading mb-8 max-w-[920px] mx-auto">
          {title}
        </h2>
        <p className="font-body text-foreground-muted text-body font-light leading-body max-w-[620px] mx-auto mb-12">
          {body}
        </p>
