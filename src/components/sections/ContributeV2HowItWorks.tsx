...
export function ContributeV2HowItWorks() {
  ...
  return (
    <Section id="v2-how">
      ...
      <h2 className="font-display uppercase text-foreground-secondary text-chapter leading-none tracking-heading mb-12 max-w-[720px]">
        {title}
      </h2>
        ...
        <div className="relative grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          ...
          {CONTRIBUTE_V2_STEPS.map((step) => (
            <div key={step.num} className="step relative pt-0">
              ...
              <h3 className="font-display uppercase text-foreground-secondary text-subhead leading-display tracking-heading mb-4">
                {step.title}
              </h3>
