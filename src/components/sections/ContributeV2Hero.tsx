        ...
        <div className="relative z-10 max-w-[1100px] mx-auto px-6 md:px-8 pt-32 pb-16 md:pt-40 md:pb-28">
          <div className="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-12 md:gap-16 items-end">
            ...
            <div>
              ...
              <h1 className="page-hero-line font-display uppercase text-foreground leading-display tracking-heading text-hero max-w-[760px]">
                {headline}
              </h1>
              <div
                aria-hidden="true"
            ...
            <div className="relative md:pt-2">
              <p className="page-hero-sub font-body italic text-foreground-muted text-body font-light leading-body max-w-[320px]">
                {subtitle}
              </p>

              <div
                aria-hidden="true"
                className="hidden md:block absolute top-0 right-0 translate-x-1/2 font-display uppercase text-foreground-muted tracking-[0.4em] text-[11px] leading-none"
                style={{
