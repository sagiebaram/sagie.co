    ...
    <main id="main-content" className="relative">
      ...
      <Section id="ven-hero" className="pt-28 md:pt-36">
        <PageHeroAnimation>
          ...
          <SplitTextReveal as="h1" className="font-display uppercase text-hero leading-display tracking-heading mb-8" lines={[
            { text: 'TRUST CREATES', className: 'text-foreground-muted' },
      ...
      <Section id="ven-model">
        <AnimatedSection>
          ...
          <SplitTextReveal as="h2" className="font-display uppercase text-chapter leading-display tracking-heading mb-8" lines={[
            { text: 'NOT A FUND.', className: 'text-foreground-muted' },
      ...
      <Section id="ven-how">
        <AnimatedSection>
          ...
          <SplitTextReveal as="h2" className="font-display uppercase text-chapter leading-display tracking-heading mb-12" lines={[
            { text: 'FROM ECOSYSTEM', className: 'text-foreground-muted' },
          ...
          {STEPS.map((step, i) => (
            <AnimatedSection key={step.num} delay={i * 0.1}>
              <div className="h-full py-6 border-t border-ventures-dim">
                <p className="font-display text-ventures text-label tracking-heading mb-2">
                  {step.num}
                </p>
      ...
      <Section id="ven-portfolio">
        ...
        <AnimatedSection delay={0.4}>
          <p className="font-body italic text-foreground-muted text-body leading-body font-light text-center max-w-[560px] mx-auto">
              ...
              <ul className="space-y-4">
                {AMBASSADOR_DO.map((item) => (
                  <li key={item} className="flex items-start gap-3">
                    ...
                    <span className="font-body text-foreground-muted text-body leading-body font-light">
                      {item}
                    </span>
                  </li>
                ))}
      ...
      <Section id="ven-cta">
        <AnimatedSection className="text-center mb-12">
          <SplitTextReveal as="h2" className="font-display uppercase text-hero-cta leading-display tracking-heading mb-8" lines={[
            { text: "LET'S BUILD", className: 'text-foreground-muted' },
            { text: 'TOGETHER.', className: 'text-foreground-secondary' },
          ]} />
          <p className="font-body italic text-foreground-muted font-light text-body leading-body max-w-[520px] mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <AnimatedSection delay={0.1}>
            <div className="h-full rounded-sm border border-ventures-dim bg-ventures-bg p-8 flex flex-col">
              <h3 className="font-display uppercase text-ventures-bright text-chapter tracking-heading mb-4">
                I&apos;m an Investor
              </h3>
              <p className="font-body text-foreground-muted text-body leading-body font-light mb-8 flex-1">
